...
export const BaseEvent = z
  .object({
    ...
    rho: optionalNumber,
    phi: optionalNumber,
    vanna: optionalNumber,
    vomma: optionalNumber,
    speed: optionalNumber,
    charm: optionalNumber,
    color: optionalNumber,
    ultima: optionalNumber,
    markPrice: optionalNumber,
    theoreticalPrice: optionalNumber,
    underlyingPrice: optionalNumber,
    underlyingSymbol: optionalString,
    callVolume: optionalNumber,
    putVolume: optionalNumber,
    callOpenInterest: optionalNumber,
    putOpenInterest: optionalNumber,
    frontVolatility: optionalNumber,
    backVolatility: optionalNumber,
    atmVolatility: optionalNumber,
  })
  .passthrough();
